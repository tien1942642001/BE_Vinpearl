...
public interface PostRepository extends JpaRepository<Post, Long> {
    ...
    @Query("SELECT new dev.kienntt.demo.BE_Vinpearl.domain.dto.PostListDto(p.id, p.name, p.path, p.publishedAt, COUNT(DISTINCT l.id), COUNT(DISTINCT c.id)) FROM Post p " +
